...
firma_sp_1 = FirmaSpozywcza(
    "ABC", "Kamil Baran", 121.5, 6, "Chorzów, ul. Kościuszki 64"
)
firma_sp_2 = FirmaSpozywcza(
    "Sklepik osiedlowy", "Ewa Nowakowska", 76, 3, "Katowice, ul. Zielona 75"
)
...
kurs1 = Kurs(
    [firma_tr, firma_sp_1, firma_sp_2, firma_tr],
    "Jan Kowalski",
    pojazd1,
    "2.5",
